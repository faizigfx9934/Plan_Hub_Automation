...
# Scraper .env (BOM-free, built with string concatenation for PS 5.1 compatibility)
$NL = [Environment]::NewLine
$EnvContent = "# Generated by Setup Script $(Get-Date)" + $NL
...
$EnvContent += "START_DATE_OFFSET=4" + $NL
...
$OcrConfig += 'DISCORD_WEBHOOK_URLS = [' + $NL
$OcrConfig += '    "https://discord.com/api/webhooks/1496914813735927950/gTWQFxHkWuABBkRu0vbpWJq2FWdhjH8n3JloB9AhmpO-RUhE91EOrdjp8kPkRAh4IHS2",' + $NL
$OcrConfig += ']' + $NL
$OcrConfig += 'NUM_WORKERS = 2' + $NL
$OcrConfig += 'MIN_CONFIDENCE = 0.6' + $NL
Write-BomFreeFile -Path "$OcrDir\config.py" -Content $OcrConfig

# OCR Google Credentials (Base64 to BOM-free JSON)
$B64Creds = ''
