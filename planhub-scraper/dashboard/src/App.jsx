    ...
    <div className="dashboard-layout">
      ...
      <main className="main-viewport">
        ...
        {activeTab === 'dashboard' && (() => {
          ...
          const isOnline = myLaptop && (Date.now() - myLaptop.last_seen) < 60 * 1000; // Reduced from 5m to 1m for 'live' status
          return (
        ...
        {activeTab === 'laptops' && (
          <div className="laptops-grid fade-enter-active">
            {laptops.map(laptop => {
              const isOnline = (Date.now() - laptop.last_seen) < 60 * 1000; // Reduced from 5m to 1m for 'live' status
              return (
